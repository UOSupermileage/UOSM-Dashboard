...
class Card {
public:
    Card(lv_obj_t * parent, const char * title, const char * value, const int32_t width, const int32_t height) : width(width), height(height) {
...
public:
    DualCardInfo() {}
    DualCardInfo(lv_obj_t * parent, const char * title1, const char * value1, const char * title2, const char * value2, const int32_t width, const int32_t height) : width(width), height(height) {
        static int32_t col_dsc[] = {width, LV_GRID_TEMPLATE_LAST};
